...
// TestMigrateRefTags_Basic verifies that @knownid → #knownid in daily files while
// @nonid tokens and #already-migrated tokens are left untouched.
...
// TestMigrateRefTags_UnknownIdUntouched verifies that @tokens whose body is not
// a known project/story id are never rewritten.
